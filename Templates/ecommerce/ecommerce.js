...
function fetchproducts(productsdata){
  let productdata=productsdata.map((meriproducts)=>{
    return `<div class="product">
    <img src="${meriproducts.thumbnail}" alt="">
        <h5>${meriproducts.category}</h5>
        <h2>${meriproducts.title}</h2>
        <p>${meriproducts.description}</p>
        <footer>
            <h4>$${meriproducts.price}</h4>
            <h4 class="discount">${meriproducts.discountPercentage}</h4>
        </footer>
    </div>`;
  })
  .join(" ");
...
// let products=document.querySelector(".products");
// let mappeddata=data.products.map((meriproducts)=>{
//     return `<div class="product">
//     <img src="${meriproducts.thumbnail}" alt="">
//         <h5>${meriproducts.category}</h5>
//         <h2>${meriproducts.title}</h2>
...
getallproducts();
function getfilteration(category){
    let filteration=data.products.filter((meriproducts)=>
        meriproducts.category===category
    );
//     let products=document.querySelector(".products");
//     let mappeddata=filteration.map((meriproducts)=>{
//     return `<div class="product">
//     <img src="${meriproducts.thumbnail}" alt="">
//         <h5>${meriproducts.category}</h5>
//         <h2>${meriproducts.title}</h2>
...
//     </div>`;
// })
fetchproducts(filteration)
}
function searchproducts(){

  let input=document.querySelector("input[name='search']").value.toLowerCase();
  let searching=data.products.filter((meriproducts)=>{

    return meriproducts.title.toLowerCase().startsWith(input);
  }
  );
  fetchproducts(searching);
}